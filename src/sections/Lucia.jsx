...
const Lucia = () => {
    useGSAP(()=>{
        // Add any GSAP animations or ScrollTriggers here if needed
        gsap.set('.lucia-life' , {
            opacity : 0,
            marginTop : '-80vh'
        })
        ...
        .to('.lucia-life', { opacity: 1, duration: 1, ease: 'power1.inOut' })
    },[])
        ...
        <section className="lucia-life">
            ...
            <div className="flex flex-col gap-5 items-end img-box lg:1/2 ps-10 mt-96">
                <div className="lucia-1">
                    <img src="/images/lucia-1.webp" alt="" className="lucia-1" />
                </div>
                <div className="lucia-3">
                    <img src="/images/lucia-3.webp" alt="" className="lucia-3" />
                </div>
            </div>
            <div className="lg:w-1/2 lucia-life-content">
                <div className="max-w-xl lg:ps-32 p-10">
                    <h1>Lucia Caminos</h1>
                ...
                <div className="lucia-2">
                    <img src="/images/lucia-2.webp" alt="lucia-2" className="lucia-2" />
                </div>
